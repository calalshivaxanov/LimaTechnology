        ...
        <div class="col-md-4">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?=post('email')?>" class="form-control" id="email" name="email" placeholder="E-posta adresinizi yazın..">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="password-again">Şifrəniz (Təkrar)</label>
                    <input type="password" value="<?=post('password_again')?>" class="form-control" id="password-again" name="password_again" placeholder="*******">
                </div>
