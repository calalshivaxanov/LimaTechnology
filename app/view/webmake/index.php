...
?>
    ...
    <div id="loader">
        <div class="center"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <section id="first-section">
        ...
        <div class="content">
            <h1 class="oneh1"><?=setting('welcome_title')?></h1>
            <br>
            <div> <span id="typed"></span> <span style="font-size: 2rem;"><?=setting('welcome_text')?></span></div>
        </div>
    ...
    <section id="about-section">
        <div class="for-mobile">
            <div class="sides">
                ...
                <div>
                    <p>Lorem Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed quisquam placeat nostrum
                        veniam earum quo error sit, tempore sequi deserunt nesciunt dicta? Nulla at eos possimus magni
                        nemo quam culpa! ipsum dolor, sit amet consectetur adipisicing elit. Asperiores est neque
                        pariatur placeat ea. Nam rerum, optio pariatur perspiciatis culpa debitis ut iste ea corrupti
                        saepe? Dolorum corrupti fugit sint?</p>
                </div>
            </div>
            <div class="sides">
                <div class="title">
    ...
    <section id="services-section" class="for-mobile">
        <h2 style="text-align: center;">XİDMƏTLƏRİMİZƏ GÖZ GƏZDİRİN</h2>
        <br>
        <br>
        <hr>
        <br>
        <br>
        <div class="middle">
            <div class="box-div from-bottom-animation">
                <div class="top-box">
                    ...
                    <div class="content">
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, natus quaerat? Molestiae facilis minus quia odit perferendis consequuntur saepe dignissimos iste beatae quis, ratione magnam obcaecati cumque ipsum, at illum?</p>
                    </div>
    ...
    <section id="team-section" class="for-mobile from-left-animation">
        <h2 style="text-align: center;">BİZİM KOMANDA İLƏ TANIŞ OLUN</h2>
        <br>
        <br>
        <div class="middle">
            <div href="#" class="member">
                <div class="member-shape">
                    <div class="about">
                        <a href="/team_member.html">
                            <div class="for-safe">
                                <h3>Nargiz Shikhaliyeva</h3>
                                <br>
                                <br>
                                <h5>Full Stack Developer</h5>
                                <br>

                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet dolorum dolorem
                                    voluptatum
                                    asperiores, consequatur aliquid in illo quo repellat eligendi? Praesentium magnam
                                    neque
                                    porro, iure ipsa necessitatibus officia est dolor!</p>
                                <br>
                                <br>
                                <br>
                    ...
                    <div class="image">
                        <img src="https://previews.123rf.com/images/dragonimages/dragonimages1802/dragonimages180201123/98340151-software-developer.jpg"
                            alt="">
                    </div>
                    ...
                    <div class="name-sec">
                        ...
                        <div id="social">
                            <a href="/insta"><i class="fab fa-facebook-f"></i></a>
