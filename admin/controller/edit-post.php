...
if (post('submit')){
    ...
    if (!$post_url || !$post_content || !$post_status || !$post_categories ){
        ...
        if ($query){
            $error = '<strong>' . $post_title . '</strong> adında bir post var, zəhmət olmasa başqasını yoxlayın';
        } else {
